...
define('SECRET_KEY', 'Enterpr1se_2026_Ch4ngeM3!');

// Formule 3: Aucune limite
define('MAX_TRUCKS', 999999);
define('MAX_SITES', 999999);
define('MAX_USERS', 999999);

// Nom de l'entreprise cliente (A PERSONNALISER lors de l'installation)
define('CLIENT_NAME', 'Flotte Enterprise');
// Formule 3 - Licence 9000 TND + 500 TND/mois
// Camions illimites, sites illimites, utilisateurs illimites
// + API SAGE, custom development, SLA 4h, hebergement dedie
